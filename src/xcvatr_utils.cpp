...
#include <stdlib.h>
#include <stdio.h>
#include "../../lib/utils/ansi_cli/ansi_cli.h"
#include "../../lib/utils/buffered_reader/buffered_reader.h"
#include "../../lib/utils/file/utils.h"
#include "../../lib/utils/ansi_cli/config.h"
#include "../../lib/utils/stats/histogram.h"
...
#include "../../lib/genomics_utils/mapped_read/mapped_read_tools.h"
#include "../../lib/genomics_utils/signal_track/signal_track_tools.h"
#include "../../lib/genomics_utils/variation/variation_tools.h"
#include "../../lib/genomics_utils/genome_sequence/genome_sequence_tools.h"
#include "../../lib/genomics_utils/mapped_read/mapped_read_tools.h"
#include "../../lib/nucleotide/nucleotide.h"
#include "../../lib/genomics_utils/annotation/gff_utils.h"
#include "../../lib/nomenclature/nomenclature.h"
...
void get_call_matrix_per_CaSpER_All_CNV_Segments(char* casper_all_segments_fp, int state_col_i, char* cell_id_list_fp, int min_l_disjoint_segment, char* casper_call_matrix_op_fp)
{
	fprintf(stderr, "Generating the CaSpER CNV call matrix from the pooled CaSpER segments with minimum of %d long disjoint segments.\n", min_l_disjoint_segment);
	...
	FILE* f_all_segments = open_f(casper_all_segments_fp, "r");	
	while (1)
	{
												...
												int n_randomizations)
{
	...
	{
		fprintf(stderr, "Could not understand the shuffling type @ %s(%d).\n", __FILE__, __LINE__);
		exit(0);
	}
}
